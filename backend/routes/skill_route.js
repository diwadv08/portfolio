...
router.post('/skills_add',verifyAdmin,multer_upload.single('image'),(req,res)=>{
...
router.post('/skills_edit',verifyAdmin, multer_upload.single('image'), async (req, res) => {
    try {
...
router.delete('/skills_delete/:id',verifyAdmin, async (req, res) => {
    try {
