...
router.post('/project_add',verifyAdmin,multer_upload.single('image'),(req,res)=>{
...
router.post('/project_edit',verifyAdmin,multer_upload.single('image'),async(req,res)=>{
...
router.delete('/project_delete/:id',verifyAdmin,async(req,res)=>{
    try {
