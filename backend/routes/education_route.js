...
router.post('/education_add',verifyAdmin,(req,res)=>{
...
router.post('/education_edit',verifyAdmin,async(req,res)=>{
...
router.delete('/education_delete/:id',verifyAdmin,async(req,res)=>{
